...
import engine.evaluation.obb.dota as dota_eval_module
...
class EvaluatorEfficiencyTest(unittest.TestCase):
    def test_iou_is_batched_by_image_and_class(self):
        ...
        evaluator = DotaOBBEvaluator(dataset, iou_thresholds=[0.5, 0.75, 0.9])
        predictions = {}
        ...
        try:
            ...
            dota_eval_module.rotated_iou = original_rotated_iou
